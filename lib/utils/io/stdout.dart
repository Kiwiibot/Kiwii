...
/// A string sink that handles writing to a file and stdout.
class Stdout implements StringSink {
  ...
  /// Create a new instance of the [Stdout] sink.
  Stdout(this.file, this.sink);
