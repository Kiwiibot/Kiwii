...
let _fonts: Record<string, Font> = {};

export const fonts: Record<string, Font> =
  Object.keys(_fonts).length === 0
    ? await registerFontsIn(path.join(__dirname, "..", "..", "..", "assets", "fonts"))
    : _fonts;

export async function registerFontsIn(filepath: string) {
